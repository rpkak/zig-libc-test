...
pub fn build(b: *std.Build) !void {
    ...
    installSimpleTestCase(&libc_test, "functional/strtold.c", .{ .musl = .passes, .mingw = .unstable }, false);
    ...
    installSimpleTestCase(&libc_test, "math/asinl.c", .{ .musl = .passes, .mingw = .unstable }, false);
    ...
    installSimpleTestCase(&libc_test, "math/atan2l.c", .{ .musl = .passes, .mingw = .unstable }, false);
    ...
    installSimpleTestCase(&libc_test, "math/atanl.c", .{ .musl = .passes, .mingw = .unstable }, false);
    ...
    installSimpleTestCase(&libc_test, "math/expm1l.c", .unstable, false);
    ...
    installSimpleTestCase(&libc_test, "math/hypotl.c", .unstable, false);
    ...
    installSimpleTestCase(&libc_test, "math/log10l.c", .{ .musl = .passes, .mingw = .unstable }, false);
    installSimpleTestCase(&libc_test, "math/log1p.c", .unstable, false);
    installSimpleTestCase(&libc_test, "math/log1pf.c", .unstable, false);
    installSimpleTestCase(&libc_test, "math/log1pl.c", .unstable, false);
    ...
    installSimpleTestCase(&libc_test, "math/log2l.c", .{ .musl = .passes, .mingw = .unstable }, false);
    ...
    installSimpleTestCase(&libc_test, "math/scalbln.c", .{ .musl = .passes, .mingw = .unstable }, false);
    installSimpleTestCase(&libc_test, "math/scalblnf.c", .{ .musl = .passes, .mingw = .unstable }, false);
    installSimpleTestCase(&libc_test, "math/scalblnl.c", .{ .musl = .passes, .mingw = .unstable }, false);
    installSimpleTestCase(&libc_test, "math/scalbn.c", .{ .musl = .passes, .mingw = .unstable }, false);
    installSimpleTestCase(&libc_test, "math/scalbnf.c", .{ .musl = .passes, .mingw = .unstable }, false);
    installSimpleTestCase(&libc_test, "math/scalbnl.c", .{ .musl = .passes, .mingw = .unstable }, false);
    ...
    installSimpleTestCase(&libc_test, "math/sinhl.c", .unstable, false);
    ...
    installSimpleTestCase(&libc_test, "math/tanhl.c", .{ .musl = .passes, .mingw = .unstable }, false);
